...
class Ui_Window_login(object):
    def setupUi(self, Window_login):
        ...
        Window_login.resize(300, 400)
        Window_login.setMinimumSize(QtCore.QSize(300, 400))
        Window_login.setMaximumSize(QtCore.QSize(300, 400))
        icon = QtGui.QIcon()
...
"")
        ...
        self.frame.setGeometry(QtCore.QRect(30, 80, 241, 251))
...
"}")
        ...
        self.label_7.setGeometry(QtCore.QRect(50, 170, 161, 31))
...
"}")
        ...
        self.pushButton_3.setGeometry(QtCore.QRect(70, 200, 91, 31))
...
"}")
        ...
        self.label_4.setGeometry(QtCore.QRect(90, 9, 51, 51))
...
"color:qlineargradient(spread:pad, x1:0.075, y1:0.977, x2:0.835, y2:0.170455, stop:0.0852273 rgba(255, 57, 107, 255), stop:0.676136 rgba(255, 241, 131, 255))")
        ...
        self.label_5.setGeometry(QtCore.QRect(120, 19, 101, 41))
...
"color:qlineargradient(spread:pad, x1:0.671, y1:0.108, x2:0.255045, y2:0.801, stop:0.0852273 rgba(255, 57, 107, 255), stop:0.676136 rgba(255, 241, 131, 255))")
        ...
        self.label_6.setGeometry(QtCore.QRect(70, 50, 171, 16))
...
"color: rgb(255, 255, 255);")
        ...
        self.Button_iniciar.setGeometry(QtCore.QRect(50, 350, 91, 31))
...
"}")
        ...
        self.pushButton_2.setGeometry(QtCore.QRect(160, 350, 91, 31))
...
"}")
    ...
    def retranslateUi(self, Window_login):
        ...
        self.label.setText(_translate("Window_login", "INICIAR SESIÓN"))
        ...
        self.label_7.setText(_translate("Window_login", "¿No tienes un Usuario?"))
        self.pushButton_3.setText(_translate("Window_login", "Crear Usuario"))
